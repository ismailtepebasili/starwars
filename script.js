...
showCharactersButton.style.backgroundColor = "#a9e984"; // Başlangıç buton

const paragrapgh = document.getElementById("parag");
paragrapgh.style.display = "none";
paragrapgh.style.color = "white";
...
// const homeWorldObject = {};

// homeworldsRaw.forEach((homeworld) => {
//   homeWorldObject[homeworld] = true;
// });

// const homeworldsUnique = Object.keys(homeWorldObject);
